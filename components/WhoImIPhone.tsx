  ...
  return (
    <div className="">
      ...
      >
        ...
        >
          <section className="text-justify z-10 m-5 md:hidden absolute shadow-2xl text-gray-600 bg-amber-50/80 hover:bg-amber-50 md:w-[400px] p-5 rounded-br-2xl rounded-bl-2xl rounded-tr-4xl h-52 hover:h-142  md:hover:h-112  sm:hover:h-82 transition-all duration-500 overflow-hidden">
            ...
            and motivated to continue learning and gaining expertise,
            particularly in Artificial Intelligence, Business Analysis, and
            Business Management. I aim for a deep and comprehensive
            understanding of these fields and their integration.
            {/* طبقة التدرج السفلي */}
